...
def main():
    ...
    features_data['instrument_type_first_traded'] = features_data['instrument_type_first_traded'] ** 2

    #features_data['first_deposit_amount'] = features_data['first_deposit_amount'] **1.3
    features_data['time_spent'] = features_data['time_spent'] ** 1.3
    # print(features_data.columns)
    #features_data['instrument_type_first_traded'] = features_data['instrument_type_first_traded'] ** 1.2
